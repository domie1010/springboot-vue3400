...
<html>
 ...
 if(cx.equals("注册用户")){sql="select * from yonghuzhuce where yonghuming='"+uid+"' and mima='"+pwd+"' ";}
 if(cx.equals("农家院")){sql="select * from nongjiayuan where shangjiabianhao='"+uid+"' and mima='"+pwd+"' and issh='是'";}
 //quxanxiaxndexnglxu
