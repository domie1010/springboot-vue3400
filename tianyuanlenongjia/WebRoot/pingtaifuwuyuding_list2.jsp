...
body,td,th {
			  ...
			  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="pingtaifuwuyudingList2.do" name="myform" method="post">
    ...
    <a href="zhifu.jsp?id=${u.id }&biao=pingtaifuwuyuding">支付</a>
    </c:if></td>
    <td align='center'>${u.issh} </td>
		 ...
		 <%
			String sql="select * from pingtaifuwuyuding where yonghuming='"+(String)request.getSession().getAttribute("username")+"'  ";
...
while(RS_result.next()){
		...
		共计金额:<%=jinez%>； 
		 ...
		 <c:if test="${page.page>1}">
              <a href="pingtaifuwuyudingList2.do?page=1" >首页</a>
             <a href="pingtaifuwuyudingList2.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="pingtaifuwuyudingList2.do?page=${page.page+1 }">下一页</a>
			<a href="pingtaifuwuyudingList2.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
