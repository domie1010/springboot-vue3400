...
function gows()
{
	document.location.href="pingtaifuwu_add.jsp?id=<%=id%>";
}
	...
	<body>
			<form action="updatePingtaifuwu.do" name="form1" method="post">
				      <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1"  style="border-collapse:collapse" bgcolor="#F2FDFF">
						...
						<script language="javascript">document.form1.bianhao.value='${pingtaifuwu.bianhao}';</script>	<script language="javascript">document.form1.mingcheng.value='${pingtaifuwu.mingcheng}';</script>	<script language="javascript">document.form1.leibie.value='${pingtaifuwu.leibie}';</script>	<script language="javascript">document.form1.jiage.value='${pingtaifuwu.jiage}';</script>	<script language="javascript">document.form1.jianjie.value='${pingtaifuwu.jianjie}';</script>	<script language="javascript">document.form1.faburen.value='${pingtaifuwu.faburen}';</script>	
					 </table>
			</form>
   </body>
</html>
