...
-->
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
				...
				<td>
					<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
						<tr align="left" bgcolor="#F2FDFF">
							<td colspan="17" background="images/table_header.gif">农家院列表</td>
						</tr>
					</table>
				</td>
			</tr>
			  ...
			  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="nongjiayuanList.do" name="myform" method="post">
				...
				%>
                            <tr align="center" bgcolor="#FFFFFF">
                             ...
                             <td>${u.shangjiabianhao}</td>    <td>${u.shanghumingcheng}</td>    <td width='90' align='center'><a href='${u.yingyezhizhao}' target='_blank'><img src='${u.yingyezhizhao}' width=88 height=99 border=0 /></a></td>    <td>${u.fuwurexian}</td>    <td>${u.shanghudizhi}</td>    <td>${u.zhuyingxiangmu}</td>        <td>${u.mima}</td>    <td align='center'>${u.issh} <input type="button" value="审核" onclick="javascript:location.href='sh.jsp?id=${u.id}&yuan=${u.issh}&tablename=nongjiayuan'"/></td>
                              ...
                              <td align="center"><a href="doUpdateNongjiayuan.do?id=${u.id }">编辑</a>  <a href="deleteNongjiayuan.do?id=${u.id }"
										onclick="{if(confirm('确定要删除吗?')){return true;}return false;}">删除</a> <a href="njyDetail.do?id=${u.id}" target="_blank">详细</a></td>
                            </tr>
                          </c:forEach>
                        </table></td>
						</tr>
		 ...
		 <c:if test="${page.page>1}">
              <a href="nongjiayuanList.do?page=1" >首页</a>
             <a href="nongjiayuanList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="nongjiayuanList.do?page=${page.page+1 }">下一页</a>
			<a href="nongjiayuanList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
