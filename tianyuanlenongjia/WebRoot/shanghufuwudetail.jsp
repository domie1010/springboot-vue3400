...
<div class="news_content">
   ...
   <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="font-size:14px;border-collapse:collapse"  class="newsline">  
      <tr>
		 <td width='11%' height=44>编号：</td><td width='39%'>${shanghufuwu.bianhao}</td><td  rowspan=6 align=center><a href=${shanghufuwu.zhutu} target=_blank><img src=${shanghufuwu.zhutu}  width=228 height=215 border=0></a></td></tr><tr>
         <td width='11%' height=44>名称：</td><td width='39%'>${shanghufuwu.mingcheng}</td></tr><tr>
         
         <td width='11%' height=44>类别：</td><td width='39%'>${shanghufuwu.leibie}</td></tr><tr>
         <td width='11%' height=44>价格：</td><td width='39%'>${shanghufuwu.jiage}</td></tr><tr>
         
         <td width='11%' height=44>商户编号：</td><td width='39%'>${shanghufuwu.shanghubianhao}</td></tr><tr>
         <td width='11%' height=44>商户名称：</td><td width='39%'>${shanghufuwu.shanghumingcheng}</td></tr><tr>
         <td width='11%' height=100  >简介：</td><td width='39%' colspan=2 height=100 >${shanghufuwu.jianjie}</td></tr><tr>							 
                                <td colspan="3"><table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="00FFFF" style="border-collapse:collapse" class="newsline">
								  ...
								  <%@page import="com.util.db"%>
                                   <%
								   int pli=0;
    for(HashMap map:new db().getpinglun("shanghufuwu",id)){
	pli=pli+1;
     %>
                                   <tr>
...
<input type=button name=Submit52 value=预订 onClick="javascript:location.href='shanghufuwuyudingadd.jsp?id=${shanghufuwu.id}'" /> <!--jixaaxnnxiu-->
<input type=button name=Submit53 value=评论 onClick="javascript:hsgpinglun('shanghufuwu','<%=id%>')"/>
</td></tr>
