...
<input type=button name=Submit52 value=打印 onClick="javascript:window.print()"  /> <input type="button" name="pingtaifuwupingtaifuwuyuding" value="平台服务预订" onclick="javascript:location.href='pingtaifuwuyudingadd.jsp?id=${pingtaifuwu.id}';"> <!--jixaaxnnxiu-->
<input type=button name=Submit53 value=评论 onClick="javascript:hsgpinglun('pingtaifuwu','<%=id%>')"/>
</td></tr>
