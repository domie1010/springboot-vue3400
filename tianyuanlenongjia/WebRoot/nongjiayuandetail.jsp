...
<div class="news_content">
   ...
   <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse"  class="newsline">  
      <tr>
		 <td width='11%' height=44>商家编号：</td><td width='39%'>${nongjiayuan.shangjiabianhao}</td><td  rowspan=6 align=center><a href=${nongjiayuan.yingyezhizhao} target=_blank><img src=${nongjiayuan.yingyezhizhao}  width=228 height=215 border=0></a></td></tr><tr>         <td width='11%' height=44>商户名称：</td><td width='39%'>${nongjiayuan.shanghumingcheng}</td></tr><tr>                  <td width='11%' height=44>服务热线：</td><td width='39%'>${nongjiayuan.fuwurexian}</td></tr><tr>         <td width='11%' height=44>商户地址：</td><td width='39%'>${nongjiayuan.shanghudizhi}</td></tr><tr>         <td width='11%' height=44>主营项目：</td><td width='39%'>${nongjiayuan.zhuyingxiangmu}</td></tr><tr>                  <td width='11%' height=44>密码：</td><td width='39%'>******</td></tr><tr>         <td width='11%' height=100  >商户简介：</td><td width='39%' colspan=2 height=100 >${nongjiayuan.mima}</td></tr><tr>							 
