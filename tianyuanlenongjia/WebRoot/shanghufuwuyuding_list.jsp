...
-->
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0">
			  ...
			  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#aec3de">
					...
					<tr align="right" bgcolor="#ebf0f7">
					  ...
					  <table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
						<tr align="left" >
							<td colspan="17">
								<form action="shanghufuwuyudingList.do" name="myform" method="post">
		 ...
		 <%
			String sql="select * from shanghufuwuyuding where 1=1 ";
...
while(RS_result.next()){
		...
		共计金额:<%=jinez%>； 
		 ...
		 <c:if test="${page.page>1}">
              <a href="shanghufuwuyudingList.do?page=1" >首页</a>
             <a href="shanghufuwuyudingList.do?page=${page.page-1 }"> 上一页</a>             </c:if>
    	     <c:if test="${page.page<page.totalPage}">
			<a href="shanghufuwuyudingList.do?page=${page.page+1 }">下一页</a>
			<a href="shanghufuwuyudingList.do?page=${page.totalPage }">末页</a>		    </c:if>		
	</c:if>
	</p>
