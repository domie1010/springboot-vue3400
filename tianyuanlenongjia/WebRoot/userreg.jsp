...
<div class="center-content">
	<div class="leftbox">
          <div class="c-left">
              <ul><h2>用户注册/<span>UserReg</span></h2></ul>
              <!--<ol>
                  <li><a href="#">公司新闻</a></li>
                  <li><a href="#">行业动态</a></li>
				  <li><a href="#">公司新闻</a></li>
    ...
    <div class="c-right">
    	<div class="tree-nav">
        	<h2>用户注册</h2>
            <p><a href="index.do">首页</a>/ 用户注册</p>
        </div>
<div class="news_content">
                                
								  <table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#CCCCCC" style="border-collapse:collapse" class="newsline" height=600>
		...
		<tr 2><td width="200">备注：</td><td><textarea name='beizhu' cols='50' rows='5' id='beizhu' onblur='' style='border:solid 1px #000000; color:#666666' ></textarea></td></tr>
			...
			<script language="javascript">popheight = 650;</script>
