...
<div class="container">
	...
	<div class="leftsidebar_box">
		...
		<dl class="custom">
			<dt onClick="changeImage()">新闻公告管理<img src="images/left/select_xl01.png"></dt>
			<dd class="first_dd"><a href="xinwentongzhi_add.jsp?lb=站内新闻" target="rightFrame">站内新闻添加</a></dd>
			<dd><a href="xinwentongzhiList.do?lb=站内新闻" target="rightFrame">站内新闻查询</a></dd>
		...
		<dl class="app">
			<dt onClick="changeImage()">农家院管理<img src="images/left/select_xl01.png"></dt>
			<dd class="first_dd"><a href="nongjiayuan_add.jsp" target="rightFrame">农家院添加</a></dd>
			<dd><a href="nongjiayuanList.do" target="rightFrame">农家院查询</a></dd>
		</dl>
	
		<dl class="cloud">
			<dt onClick="changeImage()">商户服务管理<img src="images/left/select_xl01.png"></dt>
			<dd class="first_dd"><a href="shanghufuwuList.do" target="rightFrame">商户服务查询</a></dd>
			<dd><a href="shanghufuwuyudingList.do" target="rightFrame">服务记录管理</a></dd>
		</dl>
	
		<dl class="syetem_management">
			<dt onClick="changeImage()">平台服务管理<img src="images/left/select_xl01.png"></dt>
			<dd class="first_dd"><a href="pingtaifuwu_add.jsp" target="rightFrame">平台服务添加</a></dd>
			<dd><a href="pingtaifuwuList.do" target="rightFrame">平台服务查询</a></dd>
			<dd><a href="pingtaifuwuyudingList.do" target="rightFrame">预订记录管理</a></dd>
			<%-- <dd><a href="jiankangzhibiaoList3.do" target="rightFrame">亚健康用户查询</a></dd>
			<dd><a href="youjianList.do" target="rightFrame">健康提醒查询</a></dd>
			<dd><a href="youjian_list.jsp" target="rightFrame">健康提醒查询</a></dd> --%>
		</dl>
	
		<%-- <dl class="source">
			<dt onClick="changeImage()">站内新闻管理<img src="images/left/select_xl01.png"></dt>
			<dd class="first_dd"><a href="xinwentongzhi_add.jsp" target="rightFrame">站内新闻添加</a></dd>
			<dd><a href="xinwentongzhiList.do" target="rightFrame">站内新闻查询</a></dd>
		</dl> --%>
